...
gcc -m32 -I lib/kernel/ -I lib/ -I kernel/ -c -fno-builtin -fno-stack-protector -o build/kernel/main.o kernel/main.c
...
ld build/kernel/main.o build/kernel/print.o build/init.o build/interrupt.o build/kernel/kernel.o build/timer.o -T kernel.ld -e main -o ./build/kernel/kernel.bin -m elf_i386 && \
